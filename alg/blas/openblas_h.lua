--------------------------------------------------------------------------------
-- OpenBLAS header cdef for sci.alg module.
--
...
size_t cblas_icamax(const blasint n, const float *x, const blasint incx);
size_t cblas_izamax(const blasint n, const double *x, const blasint incx);
